...
public class SecurityConfig {
    ...
    public SecurityConfig(final JwtUtil jwtUtil,final  UserDetailsService userDetailsService) {
    ...
    @Bean
    public SecurityFilterChain filterChain(final HttpSecurity http, @Qualifier("corsConfigurationSource") final CorsConfigurationSource corsConfig) throws Exception {
